...
public class SensitivityController {
   ...
   */
  @SuppressWarnings("unchecked")
  @PutMapping(value = "/sensitiveValue/{id}/userName/{userId}")
  @ResponseBody
  public String clearSensitivityValue(@PathVariable("id") Long id, @PathVariable("userId") Long userId) {
  ...
  /**
   * Set visit times Value.
   * 
   * @return to page sensitivity page
   */
  @SuppressWarnings("unchecked")
  @PutMapping(value = "/visitTimes/{value}")
  @ResponseBody
  public String setTVisitTimesValue(@PathVariable("value") String value) {
    Settings s = settingsRepository.findByName("visitTimes");
    s.setVal(value);
    settingsRepository.save(s);
    JSONObject obj = new JSONObject();
    obj.put("result", "succeeded");
  ...
  public String sensitivityForm(
      @RequestParam(value = "sensitivityId", required = true) Long sensitivityId, Model model,
